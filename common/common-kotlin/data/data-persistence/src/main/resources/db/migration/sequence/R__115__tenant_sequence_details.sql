-- -----------------------------------------------------------------------------
-- Function: tenant_sequence_details
-- Description: Calculates the minimum and maximum ID range for a tenant based on an ID length constant.
-- -----------------------------------------------------------------------------
-- Examples:
--   SELECT * FROM tenant_sequence_details(1);    -- returns min_id=100000000, max_id=199999999
